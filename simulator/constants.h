...
#define TICK_SPEED 50 // ms usually 1
#define LINK_SPEED 2.0 // usually 1.0
...
#define HOST_TRANSMISSION_DELAY 1 // measurements done at 10
#define HOST_PROCESSING_DELAY 1 // measurements done at 60
